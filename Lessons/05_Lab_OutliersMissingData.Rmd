...
decompose_data = decompose(clean_wind_data)
plot(decompose_data)

#Ex2: Store the three component in separate vector
random_wind = decompose_data$random
trend_wind = decompose_data$trend
season_wind = decompose_data$seasonal


#Ex3: Create one data frame with all three vector and the Date columns from wind_data
df_wind_decomposed = data.frame("date" = full_wind_data$Date, random_wind, trend_wind, season_wind)
